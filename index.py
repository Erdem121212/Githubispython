...
os.system('clear')
print("pylinux 6.16")
print("user is user and password is 1234")
time.sleep(1.5)
enterusername = input("User: ")
enterpassword = input("Password: ")
if enterusername == 'user' and enterpassword == '1234':
    print('ok , logging you in...')
    os.system('clear')
else:
    print("Sorry but authentication system failed. Try again.")
    time.sleep(1.5)
    print("whatever here you are!")    
